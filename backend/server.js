...
try {
  ...
  console.warn("WARNING: Could not initialize Firebase Admin SDK because the service account key is missing. Running with mocked database. Error:", error.message);
  db = {
    collection: () => ({
      doc: () => ({
